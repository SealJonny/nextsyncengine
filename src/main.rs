...
fn main() {
    ...
    let file_path_arg = 
        Arg::new("file_path")
            ...
            .help("Path to the text file generated by nextsyncengine if some files failed to upload in a previous attempt");

    let local_required_group = 
        ArgGroup::new("local_required_group")
            .args(&["local_path", "file_path"])
            .required(true)
            .multiple(false);
    ...
    match matches.subcommand() {
        Some(("upload:sorted", upload_matches)) => {
            ...
            let local_path = upload_matches.get_one::<String>("local_path");
            let file_path = upload_matches.get_one::<String>("file_path");
            ...
            let path_upload: String = 
                if let Some(local) = local_path {
                    ...
                    error!("--local_path or --file is requried");
                    panic!()
                };
